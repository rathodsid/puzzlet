...
var import_api2, B3_DEBUG_FLAG_KEY;
var init_common = __esm({
  "../../node_modules/@opentelemetry/propagator-b3/build/esm/common.js"() {
    import_api2 = require("@opentelemetry/api");
    B3_DEBUG_FLAG_KEY = (0, import_api2.createContextKey)("OpenTelemetry Context Key B3 Debug Flag");
  }
});
...
function isValidSampledValue(sampled) {
  return sampled === import_api3.TraceFlags.SAMPLED || sampled === import_api3.TraceFlags.NONE;
}
...
function getTraceFlags(carrier, getter) {
  ...
  if (debug === "1" || VALID_SAMPLED_VALUES.has(traceFlags)) {
    return import_api3.TraceFlags.SAMPLED;
  }
  if (traceFlags === void 0 || VALID_UNSAMPLED_VALUES.has(traceFlags)) {
    return import_api3.TraceFlags.NONE;
  }
  return;
}
var import_api3, VALID_SAMPLED_VALUES, VALID_UNSAMPLED_VALUES, B3MultiPropagator;
  ...
  "../../node_modules/@opentelemetry/propagator-b3/build/esm/B3MultiPropagator.js"() {
    ...
    function() {
      ...
      B3MultiPropagator2.prototype.inject = function(context2, carrier, setter) {
        var spanContext = import_api3.trace.getSpanContext(context2);
        if (!spanContext || !(0, import_api3.isSpanContextValid)(spanContext) || isTracingSuppressed(context2))
          return;
        ...
        if (debug === "1") {
          ...
          setter.set(carrier, X_B3_SAMPLED, (import_api3.TraceFlags.SAMPLED & spanContext.traceFlags) === import_api3.TraceFlags.SAMPLED ? "1" : "0");
        }
      };
      B3MultiPropagator2.prototype.extract = function(context2, carrier, getter) {
        ...
        var debug = getDebug(carrier, getter);
        if ((0, import_api3.isValidTraceId)(traceId) && (0, import_api3.isValidSpanId)(spanId) && isValidSampledValue(traceFlags)) {
          context2 = context2.setValue(B3_DEBUG_FLAG_KEY, debug);
          return import_api3.trace.setSpanContext(context2, {
            traceId,
            spanId,
            isRemote: true,
            traceFlags
...
function convertToTraceFlags(samplingState) {
  if (samplingState && SAMPLED_VALUES.has(samplingState)) {
    return import_api4.TraceFlags.SAMPLED;
  }
  return import_api4.TraceFlags.NONE;
}
var import_api4, __read, B3_CONTEXT_REGEX, PADDING, SAMPLED_VALUES, DEBUG_STATE, B3SinglePropagator;
  ...
  "../../node_modules/@opentelemetry/propagator-b3/build/esm/B3SinglePropagator.js"() {
    ...
    function() {
      ...
      B3SinglePropagator2.prototype.inject = function(context2, carrier, setter) {
        var spanContext = import_api4.trace.getSpanContext(context2);
        if (!spanContext || !(0, import_api4.isSpanContextValid)(spanContext) || isTracingSuppressed(context2))
          return;
      ...
      B3SinglePropagator2.prototype.extract = function(context2, carrier, getter) {
        ...
        if (!(0, import_api4.isValidTraceId)(traceId) || !(0, import_api4.isValidSpanId)(spanId))
          return context2;
        var traceFlags = convertToTraceFlags(samplingState);
        if (samplingState === DEBUG_STATE) {
          context2 = context2.setValue(B3_DEBUG_FLAG_KEY, samplingState);
        }
        return import_api4.trace.setSpanContext(context2, {
          traceId,
          spanId,
          isRemote: true,
          traceFlags
...
var import_api5, __values, __read2, UBER_TRACE_ID_HEADER, UBER_BAGGAGE_HEADER_PREFIX, JaegerPropagator, VALID_HEX_RE;
  ...
  "../../node_modules/@opentelemetry/propagator-jaeger/build/esm/JaegerPropagator.js"() {
    ...
    function() {
      ...
      JaegerPropagator2.prototype.inject = function(context2, carrier, setter) {
        var e_1, _a;
        var spanContext = import_api5.trace.getSpanContext(context2);
        var baggage = import_api5.propagation.getBaggage(context2);
        if (spanContext && isTracingSuppressed(context2) === false) {
          var traceFlags = "0" + (spanContext.traceFlags || import_api5.TraceFlags.NONE).toString(16);
      ...
      JaegerPropagator2.prototype.extract = function(context2, carrier, getter) {
        ...
        if (typeof uberTraceId === "string") {
          ...
          if (spanContext) {
            newContext = import_api5.trace.setSpanContext(newContext, spanContext);
          }
        }
        if (baggageValues.length === 0)
          return newContext;
        var currentBaggage = (_b = import_api5.propagation.getBaggage(context2)) !== null && _b !== void 0 ? _b : import_api5.propagation.createBaggage();
        try {
        ...
        newContext = import_api5.propagation.setBaggage(newContext, currentBaggage);
        return newContext;
      };
...
var require_src2 = __commonJS({
  "../../node_modules/@opentelemetry/sdk-trace-node/build/src/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.Tracer = exports2.TraceIdRatioBasedSampler = exports2.Span = exports2.SimpleSpanProcessor = exports2.SamplingDecision = exports2.RandomIdGenerator = exports2.ParentBasedSampler = exports2.NoopSpanProcessor = exports2.InMemorySpanExporter = exports2.ForceFlushState = exports2.ConsoleSpanExporter = exports2.BatchSpanProcessor = exports2.BasicTracerProvider = exports2.AlwaysOnSampler = exports2.AlwaysOffSampler = exports2.NodeTracerProvider = void 0;
...
var PUZZLET_SCORE_ENDPOINT = `v1/score`;

// src/cache.ts
var import_ttlcache = __toESM(require("@isaacs/ttlcache"));
var cache = new import_ttlcache.default({
  max: 1e4,
  ttl: 6e4
});
...
var PuzzletSampler = class {
  shouldSample(_context, _traceId, _spanName, _spanKind, attributes) {
    ...
    return {
      decision: filter ? import_sdk_trace_base.SamplingDecision.NOT_RECORD : import_sdk_trace_base.SamplingDecision.RECORD_AND_SAMPLED
    };
  }
  toString() {
...
// src/trace/tracing.ts
var import_api6 = __toESM(require("@opentelemetry/api"));
...
var MetadataKey = "ai.telemetry.metadata";
var trace4 = (options, fn) => {
  const tracer = import_api6.default.trace.getTracer("ai");
  return import_api6.context.with(
    import_api6.ROOT_CONTEXT,
    async () => tracer.startActiveSpan(options.name, async (span) => {
      if (options.metadata) {
...
var Puzzlet = class {
  ...
  async score({ resourceId, label, reason, score, name }) {
    const response = await fetch(`${this.baseUrl}/${PUZZLET_SCORE_ENDPOINT}`, {
      method: "POST",
      body: JSON.stringify({ resourceId, label, reason, score, name }),
      headers: {
        "Content-Type": "application/json",
        "X-Puzzlet-App-Id": this.appId,
        Authorization: `${this.apiKey}`
