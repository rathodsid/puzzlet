...
declare class Puzzlet<T extends {
    ...
    score({ resourceId, label, reason, score, name }: ScoreProps): Promise<any>;
}
...
declare const trace: <A extends unknown, F extends (...args: A[]) => ReturnType<F>>(options: TraceOptions, fn: F) => Promise<ReturnType<F>>;
declare const component: <A extends unknown, F extends (...args: A[]) => ReturnType<F>>(options: TraceOptions, fn: F) => Promise<ReturnType<F>>;
